      ...
      <Container>
        <Grid container spacing={3}>
          <Grid item xs={12} md={5}>
            <Box sx={{ position: 'relative', boxShadow: 2, borderRadius: 2 }}>
              <Image src="/images/IMG_10100.png" width={650} height={678} quality={97} alt="Feature img" />
              <Box
                sx={{
                  position: 'absolute',
                  top: -36,
              ...
              >
                ...
                >
                  <Typography sx={{ fontWeight: 600, lineHeight: 1 }}>Innovative Products</Typography>
          ...
          <Grid item xs={12} md={7}>
            ...
            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              Experience top-notch security solutions and precision products designed to meet your business and personal needs.
            </Typography>
